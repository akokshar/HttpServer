...
public protocol HttpResponse {
    ...
    func setSatusCode(code: Int) -> Void
}
...
class HttpServer {
    ...
    func run() {
        ...
        if self.source == nil {
            fatalError("cant create dispatch source")
        }
